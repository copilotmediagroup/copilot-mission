...
export default function GuardDashboard(props: GuardDashboardProps) {
  const { state, assignment, checkpoint=0, onAdvance, patrolEvidence=[], onEvidenceChange=()=>undefined, incidents=[], onIncidentsChange=()=>undefined, missionStartedAt=null, missionCompletedAt=null, checkpointSaving=false } = props
