...
import {
  AlertTriangle, BadgeCheck, BarChart3, Bell, BriefcaseBusiness, ClipboardList,
...
export default function AgencyMarketplace(){
  ...
  useEffect(()=>{
    ...
    const timer=window.setTimeout(()=>{
      ...
      setJobs(v=>[job,...v])
      setActivity(v=>[{id:Date.now(),time:'Now',type:job.kind==='emergency'?'emergency':'new',title:job.kind==='priority'?'New priority job':'New job posted',location:job.client},...v].slice(0,6))
  ...
  return <div className="agency-app premium-agency">
    ...
    <aside className="agency-sidebar premium-sidebar">
      ...
      <div className="sidebar-version">v1.1.0 <span><i/>Live Engine</span></div>
    </aside>
