...
import { ChevronDown, Clock3, Radio, ShieldAlert } from 'lucide-react'
...
export default function MissionTimeline() {
  ...
  return <aside className="mission-timeline-panel">
    <header><div><span className="timeline-live"><Radio/> LIVE ENGINE</span><h2>Mission Timeline</h2><p>Immutable event history for audit, reporting, and playback.</p></div><div className="timeline-count"><strong>{total}</strong><span>EVENTS</span></div></header>
