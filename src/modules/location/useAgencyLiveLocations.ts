...
import { getAgencyLiveLocations,subscribeToLiveLocations,type GuardLiveLocation } from './liveLocationRepository'
...
export function useAgencyLiveLocations(enabled:boolean){
  ...
  useEffect(()=>enabled?subscribeToLiveLocations(()=>void refresh()):undefined,[enabled,refresh])
