...
export function useMissionEngine() {
  ...
  const actions = useMemo(() => ({
    ...
    hydrateLiveState: (state: import('../../types').MissionState, missionStartedAt?: number | null, checkpoint?: number, patrolEvidence?: PatrolEvidence[], incidents?: IncidentRecord[], completedAt?: number | null) => dispatch({ type: 'HYDRATE_LIVE_STATE', state, missionStartedAt, checkpoint, patrolEvidence, incidents, completedAt }),
  }), [])
