...
export default function App() {
  ...
  return <div className={`app state-${state}`}>
    <header className="site-header"><BrandMark/><div className="hero-title"><h1>THE <em>LIVING</em> DASHBOARD</h1><p>The dashboard evolves with every step of the mission.</p></div><div className="version"><strong>v0.4.0</strong><span>VISUAL PROTOTYPE</span></div></header>
