...
import { searchVerifiedAddresses, type AddressBias, type VerifiedAddress } from './modules/location/addressSearch'
...
function PropertyModal({ clientId, onClose, onCreated }: { clientId:string|null; onClose:()=>void; onCreated:()=>void }) {
  ...
  useEffect(()=>{
    ...
    const timer=window.setTimeout(async()=>{
      ...
      try{setResults(await searchVerifiedAddresses(query,controller.signal,bias))}
