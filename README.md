...
## v0.7.3.1 — Desktop Grid & Overflow Repair

- Desktop-only patrol workspace containment repair.
- Reflows the patrol workspace into a stable two-column grid beside the fixed timeline rail.
- Moves mission metrics into a contained three-card row.
- Prevents Latest Activity, metric cards, and the Complete Checkpoint action from rendering under the timeline.
- Adds min-width and max-width guards to all desktop patrol regions.
- Mobile and tablet layouts are intentionally unchanged.
